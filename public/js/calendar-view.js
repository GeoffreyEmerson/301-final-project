$(function() {
  ...
  var dateRange = ['Saturday', 'Friday', 'Thursday', 'Wednesday', 'Tuesday', 'Monday', new Date()];
...
//start of personal preference data series
      {
        ...
        events:  {
          click: function() {
            ...
            var vote = 'vote date-time is ' +   dateRange[] + ' @ ' + event.point.series.xAxis.categories[event.point.x];
            console.log(vote);
            console.log(
